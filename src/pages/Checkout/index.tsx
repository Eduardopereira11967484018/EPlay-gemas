...
const Checkout = () => {
  ...
  const form = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      .required('O campo é obrigatório'),
      cpf: Yup.string().min(14, 'o campo precisa ter 14 caracteres')
      .max(14, 'o campo precisa ter 14 caracteres')
      .required('O campo é obrigatório'),
      deliveryEmail: Yup.string()
      .email('E-mail inválido')
      .required('O campo é obrigatório'),
      confirmDeliveryEmail: Yup.string().oneOf([Yup.ref('DeliveryEmail')], 'Os emails são diferentes')
      .required('o campo é obrigatório'),
        ...
        <div>
          ...
          <div className="margin-top">
            {payWithCard ? (
              ...
              <p>
                Ao optar por essa forma de pagamento, é importante lembrar que a confirmação pode levar até 3 dias úteis,
                devido aos prazos estabelecidos pelas instituições financeiras. Portanto,
                a liberação do código de ativação do jogo adquirido ocorrerá somente após a aprovação do pagamento do boleto.
              </p>
            )}
          </div>
        </div>
